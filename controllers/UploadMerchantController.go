...
type UploadMerchantController struct {

}

func (controller *UploadMerchantController) Upload(ctx *gin.Context)  {
	fmt.Println("UploadMerchantController")
	...
	res = services.InitUploadMerchantService(gen).UploadFile(ctx, file)
...
func (controller *UploadMerchantController) GetFilterPaging(ctx *gin.Context)  {
	...
	res = services.InitUploadMerchantService(gen).GetDataUploadMerchant(req)
...
func (controller *UploadMerchantController) HandleDownload(ctx *gin.Context) {
	...
	sugarLogger := ottologger.GetLogger()
	ctrlName := "UploadMerchantController"
	...
	pathDir := ottoutils.GetEnv("PATH_DOWNLOAD_MERCHANT","/opt/app-rose/merchant/process/")
...
func (controller *UploadMerchantController) HandleResultDownload(ctx *gin.Context) {
	...
	pathDir := ottoutils.GetEnv("PATH_DOWNLOAD_RESULT_MERCHANT","/opt/app-rose/merchant/result/")
	path := pathDir + req.FilePath
