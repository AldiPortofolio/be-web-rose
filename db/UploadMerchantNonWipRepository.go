...
type UploadMerchantNonWipRepository struct {

}

func InitUploadMerchantNonWipRepository() *UploadMerchantNonWipRepository {
	return &UploadMerchantNonWipRepository{}
}

func (repo *UploadMerchantNonWipRepository)Save(uploadMerchant *dbmodels.UploadMerchantNonWip) (error) {
	db := GetDbCon()
...
func (repo *UploadMerchantNonWipRepository) GetDataUploadMerchant(req dto.ReqUploadMerchant) ([]dbmodels.UploadMerchantNonWip, int, error) {
	db := GetDbCon()

	page := req.Page
	limit := req.Limit

	var uploadMerchant []dbmodels.UploadMerchantNonWip
	var total int
