...
type UploadMerchantWipRepository struct {

}

func InitUploadMerchantWipRepository() *UploadMerchantWipRepository {
	return &UploadMerchantWipRepository{}
}

func (repo *UploadMerchantWipRepository)Save(uploadMerchant *dbmodels.UploadMerchantWip) (error) {
	db := GetDbCon()
...
func (repo *UploadMerchantWipRepository) GetDataUploadMerchant(req dto.ReqUploadMerchant) ([]dbmodels.UploadMerchantWip, int, error) {
	db := GetDbCon()

	page := req.Page
	limit := req.Limit

	var uploadMerchant []dbmodels.UploadMerchantWip
	var total int
